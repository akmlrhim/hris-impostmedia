<div>
	...
	<div class="bg-gradient-to-br from-brand-600 to-brand-800 text-white px-5 pt-8 pb-20 rounded-b-3xl">
		<div class="flex items-center justify-between">
			...
			<a href="{{ route('mobile.profile') }}" class="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
	...
	<div class="px-4 -mt-14">
		<div class="card p-5">
			<div class="flex items-center justify-between mb-3">
				...
				<a href="{{ route('mobile.attendance') }}" class="text-sm text-brand-600 font-medium">Lihat</a>
			</div>
	...
	<div class="px-4 mt-6">
		...
		<div class="grid grid-cols-4 gap-3">
			@php
				$menus = [
					['route' => 'mobile.leave.create', 'label' => 'Cuti', 'icon' => 'calendar', 'bg' => 'bg-violet-100', 'fg' => 'text-violet-600'],
					['route' => 'mobile.attendance', 'label' => 'Absen', 'icon' => 'clock', 'bg' => 'bg-emerald-100', 'fg' => 'text-emerald-600'],
					['route' => 'mobile.reimbursement', 'label' => 'Reimburse', 'icon' => 'receipt', 'bg' => 'bg-amber-100', 'fg' => 'text-amber-600'],
					['route' => 'mobile.payslip', 'label' => 'Slip Gaji', 'icon' => 'wallet', 'bg' => 'bg-sky-100', 'fg' => 'text-sky-600'],
				];
			@endphp
			@foreach ($menus as $m)
