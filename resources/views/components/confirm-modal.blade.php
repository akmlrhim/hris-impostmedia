<div x-data="{
    ...
    <div x-show="open"
        ...
        <div class="p-2 md:p-3 text-center">
            <svg class="mx-auto mb-4 text-slate-400 w-12 h-12" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 13V8m0 8h.01M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
            </svg>
