      ...
      <template x-if="!ios">
        <div>
          ...
          <div class="flex gap-2 mt-3">
            ...
            <button @click="dismiss" class="text-xs text-slate-400 px-3 py-1.5 rounded-lg hover:text-white transition">
              Nanti
            </button>
          </div>
        </div>
        ...
        <div>
          <p class="text-xs text-slate-400 mt-0.5 leading-relaxed">
            Ketuk <strong class="text-white">
              <svg class="inline w-3.5 h-3.5 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
              </svg>
            </strong> lalu pilih <strong class="text-white">"Add to Home Screen"</strong>.
          </p>
          <button @click="dismiss" class="mt-3 text-xs text-slate-400 hover:text-white transition">
            Tutup
          </button>
        </div>
      </template>
