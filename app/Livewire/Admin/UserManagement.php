...
class UserManagement extends Component
{
    ...
    public function toggleActive(int $id): void
    {
        $this->safeAction(function () use ($id) {
            ...
            $suffix = $hasEmployee ? ' Data karyawan ikut '.($user->is_active ? 'diaktifkan.' : 'dinonaktifkan.') : '';
            $this->toast('success', ($user->is_active ? 'Akun diaktifkan.' : 'Akun dinonaktifkan.').$suffix);
