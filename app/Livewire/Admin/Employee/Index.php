...
class Index extends Component
{
    ...
    public function toggleActive(int $id): void
    {
        $this->safeAction(function () use ($id) {
            ...
            $suffix = $emp->user_id ? ' Akun pengguna ikut '.($emp->is_active ? 'diaktifkan.' : 'dinonaktifkan.') : '';
            $this->toast('success', ($emp->is_active ? 'Karyawan diaktifkan.' : 'Karyawan dinonaktifkan.').$suffix);
